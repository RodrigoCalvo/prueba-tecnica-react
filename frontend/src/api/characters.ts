...
export const getCharactersList = async (
  ...
  const url = `${API_BASE_URL}${CHARACTERS_LIST_ENDPOINT}${page}`;
...
export const getCharacter = async (
  ...
  const url = `${API_BASE_URL}${CHARACTER_PROFILE_ENDPOINT}${id}`;
...
export const getCharacterComics = async (id: number): Promise<ComicsListVM> => {
  const url = `${API_BASE_URL}${CHARACTER_COMICS_LIST_ENDPOINT}${id}`;
...
export const addComment = async (
  ...
  const url = `${API_BASE_URL}${CHARACTER_COMMENT_ADD_ENDPOINT}`;
...
export const addRating = async (
  ...
  const url = `${API_BASE_URL}${CHARACTER_RATING_ADD_ENDPOINT}`;
...
export const changeRating = async (
  ...
  const url = `${API_BASE_URL}${CHARACTER_RATING_CHANGE_ENDPOINT}`;
  const body = JSON.stringify({ characterId, rating });
  return await fetch(url, {
...
export const deleteComment = async (
  ...
  const url = `${API_BASE_URL}${CHARACTER_COMMENT_DELETE_ENDPOINT}`;
